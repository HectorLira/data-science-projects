...
- there are points in the scatter plot that "stop" at the last follow-up date (left censored).
...
### 1.d
It is. R has a packages called `survival` to fit models like this.

## Exercise 2
Follow-up dates may be left censored.
